        ...
        <>
            <section className="bg-gray-900 h-screen" id="about" >
                <div className="h-screen flex flex-col items-center justify-center">
                    ...
                    <div className="gap-16 items-center justify-center px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:px-6">
                        <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 className="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">You can call me Fathur</h2>
                        ...
                        <div className="grid grid-cols-2 gap-10">
                            <div className="max-w-xs min-h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <div className="flex items-center justify-center mt-5">
                                    <HashLink to="#projects" smooth>
                                        <img className="rounded-t-lg h-40" src={image} alt="React JS" />
                                    </HashLink>
                                </div>
                                <div className="p-5">
                                    <HashLink to="#projects" smooth>
                            ...
                            <div className="max-w-xs min-h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <div className="flex items-center justify-center mt-5">
                                    <Link to="https://www.behance.net/faturrizki" target="_blank" rel="noreferer">
                                        <img className="rounded-t-lg h-40 p-2" src={imageSecond} alt="Adobe Illustrator" />
                                    </Link>
                                </div>
                                <div className="p-5">
                                    <Link to="https://www.behance.net/faturrizki" target="_blank" rel="noreferer">
